...
public class CreditorActivity extends ActionBarActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_creditor, menu);
        return true;
    }
     ...
     */
    public static class CreditorFragment extends Fragment {
        /**
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View rootView = inflater.inflate(R.layout.fragment_creditor, container, false);
            return rootView;
        }
    }
    /**
     * A placeholder fragment containing a simple view.
     */
    public static class DebitorFragment extends Fragment {
        /**
         * The fragment argument representing the section number for this
         * fragment.
         */
         ...
         * number.
         */
        public static DebitorFragment newInstance(int sectionNumber) {
